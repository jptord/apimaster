        ...
        "groups": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {
                        "name": "frequency",
                        "value": "[[schedule_frequency|schedule_id|id]]",
                        "rel": {
                            "index": "frequency",
                ...
                "apis": [
                    ...
                    {
                        "method": "GET",
                        "route": ":schedule_id/schedule_frequency",
                        "in": null,
                        "rel": "[[schedule_frequency|schedule_id|id]]",
                        "type": "rel",
                        "out": "select_schedule_frequency"
                    },
                    {
                        "method": "GET",
                        "route": ":schedule_id/schedule_frequency/:id",
                        "in": null,
                        "rel": "[[schedule_frequency|schedule_id|id]]",
                        "type": "rel",
                        "out": "select_schedule_frequency"
                ...
                "seeder": [
                    ...
                    },
                    {
                        ...
                        "values": [
                            ...
                            "Se está atendiendo la emergencia",
                            "#ed403c",
                            "0",
                            "2"
                        ]
                    ...
                    },
                    {
                        ...
                        "values": [
                            "4",
                            "Cancelada",
                            "Emergencia cancelada por el usuario",
                            "#f8a51b",
                            "0",
                            "3"
                        ]
            ...
            },
            {
                ...
                "apicustom": [
                    {
                        ...
                        "in": "",
                        "type": "custom",
                        "out": "id,name,distance,frequency,district_id,district,color,points,assignments"
                    },
                    {
                        "method": "get",
                        "route": "sync",
                ...
                "apis": [
                    ...
                    },
                    {
                        ...
                        "in": null,
                        "rel": "[[assignments|route_id|id]]",
                        "type": "rel",
                        "out": "select_assignments"
                    },
                    {
                        "method": "GET",
                        "route": ":route_id/assignments/:id",
                        "in": null,
                        "rel": "[[assignments|route_id|id]]",
                        "type": "rel",
                        "out": "select_assignments"
                ...
                "data": {
                    "select": {
                        ...
                        "assignments": "[[assignments|route_id|id]]"
                    },
                    "create": {
                        "id": "uuid|pk",
                        "name": "string",
                ...
                "seeder": [
                    ...
                    },
                    {
                        ...
                        "values": [
                            "3",
                            "En revisión",
                            "La sugerencie se está revisando",
                            "#e1edd7",
                            "0",
                            "2"
                        ]
                    },
                    {
                        ...
                        "values": [
                            "4",
                            "Tomar en cuenta",
                            "La sugerencia es importante y se ha tomado en cuenta",
                            "#73b2af",
                            "0",
                            "4"
                        ]
                    },
                    {
                        ...
                        "values": [
                            "5",
                            "Aceptar",
                            "Se tomó en cuenta y no se realizará ninguna acción",
                            "#888888",
                            "0",
                            "4"
                        ]
            ...
            },
            {
                ...
                "data": {
                    ...
                    "custom_sync_claim_states_record": {
                        "id": "uuid|pk"
                    }
                }
            }
